...
/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4788);
/* harmony import */ var _controller_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1380);
/* harmony import */ var _weather_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(925);
...
class App {
  constructor() {
    this.view = new _weather_view_js__WEBPACK_IMPORTED_MODULE_2__/* .ForecastView */ .R();
    this.controller = new _controller_js__WEBPACK_IMPORTED_MODULE_1__/* .ForecastController */ .u(null, this.view);
  }
}
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(2436), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(4050), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(3777), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(7921), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(4855), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(9047), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(6754), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(6688), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(8767), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(6047), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(9839), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(6495), __webpack_require__.b);
...
:root {
  ...
  --color-linen: #ffede1;
  --color-ivory: #f9fbf2;
  --color-light-cyan: rgb(171, 226, 236);
  --color-jordy-blue: #afcbff;
  --color-oxford-blue: rgb(27, 28, 32);

  --default-font-size: 20px; /* 18-24px */
  --header-font-size: 55px; /* 35-50px */
  ...
  --font-bold: "oswald_demibold";
  --font-regular: "nimbus_regular";
}
...
.header-items .location-search #location {
  border-radius: 5px;
  padding-left: 2px;
  width: 100%;
  min-width: 70px;
...
.header-items .location-search button {
...
.card {
  ...
  border-radius: var(--card-border-radius);
  box-shadow: 0px 2px 6px 1px rgb(92, 150, 162);
}
...
.card .subheader span:first-child {
  color: var(--secondary-text-color);
}
...
/* Applies to the Today's Weather card */
...
.card.today .temp.lo .icon {
  background-color: rgb(127, 221, 255);
}

.card.today .temp.hi .icon {
  /* background-color: rgb(255, 150, 57); */
...
.card.today .lo-hi-temps {
  display: flex;
  justify-content: space-between;
  font-family: var(--font-bold);
}

/* Applies to the Current Weather card */
...
.card.current-weather .card-body .card-left {
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: start;
...
.card.current-weather .card-body .card-left .card-left-top {
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
.card.current-weather .card-body .card-left .degree span {
  font-size: var(--header-font-size);
  font-family: var(--font-bold);
}

.card.current-weather .card-body .card-left .degree .f-or-c .vertical-break {
  margin: 0 2px 0 4px;
  height: calc(var(--default-font-size) - 4px);
  border: 0;
  border: 0.8px solid rgb(144, 144, 144);
  border-radius: 2px;
}

.card.current-weather #celsius {
  color: rgb(163, 163, 163);
}

.card.current-weather .card-body .card-left .current-degree-feel .degree {
  display: flex;
  flex-direction: row;
...
.card.current-weather .card-body .card-left .current-degree-feel .f-or-c {
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: center;
...
.card.current-weather .card-body .feels-like-container {
  font-size: var(--secondary-text-font-size);
}

.card.current-weather .card-body .card-right {
  width: 40%;
  text-align: right;
}

.card.current-weather .card-body .card-right > div {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
...
.card.current-weather .card-body .card-right > div > span:first-child {
  display: block;
  text-align: right;
  color: var(--secondary-text-color);
  margin-right: 20px;
}
.card.current-weather .card-body .card-right hr {
  width: 100%;
  display: block;
  height: 1px;
  border: 0;
...
.card.current-weather .card-body .card-right > div > span:nth-child(2) {
  display: block;
}
...
.card.sun .icon {
  ...
  border: 6px solid rgb(255, 195, 54);
  border-radius: 50%;
}
...
.card.moon .card-body .card-left,
.card.moon .card-body .card-right {
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  gap: 10px;
...
.card.moon .icon .moon-img {
  width: 250%;
  height: 100%;
}

.card.moon .percentage {
  /* font-size: var(--header-font-size); */
}
...
.card.forecast .card-body .day .hi-lo-temp {
  padding: 5px;
  gap: 2px;
}

.card.forecast .card-body .day {
  /* padding: 5px 5px; */

  display: grid;
  grid-template-columns: 0.7fr 0.5fr 1fr 2fr 1fr;
  width: 100%;
  align-items: center;
  justify-content: space-between;
  /* gap: 20px; */
...
.card.forecast .card-body .day:first-child {
  padding-top: 0px;
}

.card.forecast .card-body .day:last-child {
  padding-bottom: 0px;
}

.card.forecast .card-body .day .icon {
  height: 40px;
  width: 40px;
}

.card.forecast .card-body .day .precipitation {
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: end;
...
.card.forecast .card-body .day .date {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
  align-items: center;
...
.card.forecast .card-body .day .week-day {
  font-weight: bold;
}

.card.forecast .card-body .day .hi {
  font-weight: bold;
  /* font-size: 24px; */
}

.card.forecast .card-body .day .lo {
  /* font-size: 18px; */
}
...
.card.forecast .card-body .day .precipitation img {
  height: 20px;
  width: 20px;
}

.location-search search form p.error {
  border: 3px solid #ff240c;
  background-color: #ffd3d3;
  color: rgb(176, 0, 0);
}

.location-search search form p.error input,
.location-search search form p.error label {
  background-color: #ffd3d3;
}
...
#location-error.error-message:after {
  content: "Please enter a valid location";
  color: rgb(176, 0, 0);
  padding: 10px;
  text-align: center;
}
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,mCAAmC;EACnC;;;;oBAIkB;EAClB,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,gCAAgC;EAChC;;;;oBAIkB;EAClB,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,6BAA6B;EAC7B;;0DAEkE;EAClE,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,0BAA0B;EAC1B;;0DAEkE;EAClE,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA,6CAA6C;AAC7C;;;EAGE,sBAAsB;AACxB;;AAEA,6BAA6B;AAC7B;EACE,SAAS;EACT,UAAU;AACZ;;AAEA,iCAAiC;AACjC;EACE;IACE,gCAAgC;EAClC;AACF;;AAEA;EACE,kCAAkC;EAClC,gBAAgB;EAChB,8BAA8B;EAC9B,mCAAmC;AACrC;;AAEA,8BAA8B;AAC9B;;;;;EAKE,cAAc;EACd,eAAe;AACjB;;AAEA,uCAAuC;AACvC;;;;EAIE,aAAa;AACf;;AAEA,4BAA4B;AAC5B;;;;;;;EAOE,yBAAyB;AAC3B;;AAEA,6BAA6B;AAC7B;EACE,iBAAiB;AACnB;AACA;;;;;;EAME,kBAAkB;AACpB;;AAEA;;CAEC;AACD;;EAEE,kBAAkB;AACpB;;AAEA;EACE,6BAA6B;EAC7B;;0DAEkE;EAClE,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,8BAA8B;EAC9B;;2DAEmE;EACnE,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,mCAAmC;;EAEnC,yBAAyB;EACzB,oBAAoB;EACpB,yBAAyB;;EAEzB,sBAAsB;EACtB,sBAAsB;EACtB,sCAAsC;EACtC,2BAA2B;EAC3B,oCAAoC;;EAEpC,yBAAyB,EAAE,YAAY;EACvC,wBAAwB,EAAE,YAAY;EACtC,gCAAgC;;EAEhC,wBAAwB;EACxB,0BAA0B;EAC1B,0CAA0C;;EAE1C,8BAA8B;EAC9B,gCAAgC;AAClC;;AAEA;;EAEE,YAAY;EACZ,iBAAiB;EACjB,2HAA2H;EAC3H,mCAAmC;AACrC;;AAEA;EACE,gBAAgB;EAChB,gBAAgB;AAClB;;AAEA,sBAAsB;AACtB;;;EAGE,gBAAgB;EAChB,cAAc;EACd,YAAY;EACZ,UAAU;EACV,aAAa;EACb,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,cAAc;EACd,YAAY;EACZ,UAAU;EACV,aAAa;EACb,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,gBAAgB;EAChB,kBAAkB;EAClB,aAAa;EACb,0BAA0B;EAC1B,4BAA4B;EAC5B,iBAAiB;EACjB,gCAAgC;EAChC,mCAAmC;AACrC;;AAEA;EACE,gBAAgB;EAChB,MAAM;;EAEN,iBAAiB;EACjB,aAAa;EACb,2CAA2C;EAC3C,uBAAuB;EACvB,uBAAuB;EACvB,mBAAmB;;EAEnB,mBAAmB;;EAEnB,0CAA0C;AAC5C;;AAEA;EACE,YAAY;;EAEZ,eAAe;;EAEf,aAAa;EACb,gCAAgC;EAChC,uBAAuB;EACvB,SAAS;EACT,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,cAAc;EACd,gBAAgB;EAChB,uBAAuB;AACzB;;AAEA;EACE,iBAAiB;EACjB,WAAW;AACb;;AAEA,wCAAwC;AACxC;EACE,aAAa;EACb,SAAS;EACT,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;;EAEnB,wCAAwC;AAC1C;;AAEA,+BAA+B;AAC/B;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,iBAAiB;;EAEjB,oCAAoC;EACpC,YAAY;EACZ,wCAAwC;EACxC,UAAU;EACV,eAAe;AACjB;;AAEA;EACE,wBAAwB;EACxB,yBAAyB;EACzB,cAAc;AAChB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,WAAW;EACX,eAAe;EACf,WAAW;AACb;;AAEA;EACE,oCAAoC;EACpC,kBAAkB;EAClB,sBAAsB;EACtB,iBAAiB;AACnB;;AAEA;EACE,6BAA6B;AAC/B;;AAEA;EACE,YAAY;EACZ,oBAAoB;EACpB,UAAU;EACV,WAAW;EACX,yBAAyB;EACzB,kBAAkB;;EAElB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;AACA,8BAA8B;AAC9B;EACE,eAAe;EACf,WAAW;EACX,yCAAyC;EACzC,aAAa;EACb,4CAA4C;EAC5C,uBAAuB;EACvB,uBAAuB;EACvB,kBAAkB;AACpB;;AAEA,sBAAsB;AACtB;EACE,WAAW;EACX,gBAAgB;;EAEhB,aAAa;EACb,2DAA2D;EAC3D,SAAS;EACT,gCAAgC;AAClC;;AAEA;;EAEE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA,uBAAuB;AACvB;EACE,gCAAgC;EAChC,eAAe;EACf,WAAW;EACX,sBAAsB;EACtB,uBAAuB;EACvB,wCAAwC;EACxC,6CAA6C;AAC/C;;AAEA;EACE,sBAAsB;EACtB,0CAA0C;EAC1C,gCAAgC;EAChC,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,8BAA8B;EAC9B,QAAQ;EACR,kCAAkC;AACpC;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,cAAc;EACd,WAAW;EACX,SAAS;EACT,6BAA6B;EAC7B,eAAe;EACf,UAAU;AACZ;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,cAAc;AAChB;;AAEA,wCAAwC;;AAExC;EACE,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,4BAA4B;EAC5B,kBAAkB;AACpB;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,yCAAyC;EACzC,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,6BAA6B;AAC/B;;AAEA,wCAAwC;;AAExC;EACE,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,wBAAwB;AAC1B;;AAEA;EACE,WAAW;EACX,aAAa;EACb,mBAAmB;EACnB,eAAe;EACf,uBAAuB;EACvB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,kBAAkB;EAClB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,kCAAkC;EAClC,6BAA6B;AAC/B;;AAEA;EACE,mBAAmB;EACnB,4CAA4C;EAC5C,SAAS;EACT,sCAAsC;EACtC,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,sBAAsB;EACtB,mBAAmB;EACnB,QAAQ;AACV;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;EACvB,QAAQ;AACV;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;EACE,UAAU;EACV,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;EACnB,QAAQ;EACR,mCAAmC;AACrC;;AAEA;EACE,cAAc;EACd,iBAAiB;EACjB,kCAAkC;EAClC,kBAAkB;AACpB;AACA;EACE,WAAW;EACX,cAAc;EACd,WAAW;EACX,SAAS;EACT,6BAA6B;EAC7B,eAAe;EACf,UAAU;EACV,iBAAiB;AACnB;;AAEA;EACE,cAAc;AAChB;;AAEA,gBAAgB;;AAEhB;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,yCAAyC;EACzC,mCAAmC;EACnC,kBAAkB;AACpB;;AAEA,iBAAiB;;AAEjB;EACE,aAAa;EACb,mBAAmB;EACnB,qBAAqB;EACrB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;AACX;;AAEA;;EAEE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,oCAAoC;EACpC,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,wCAAwC;AAC1C;;AAEA,yBAAyB;;AAEzB;EACE,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,aAAa;EACb,mBAAmB;EACnB,eAAe;EACf,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,QAAQ;AACV;;AAEA;EACE,sBAAsB;;EAEtB,aAAa;EACb,8CAA8C;EAC9C,WAAW;EACX,mBAAmB;EACnB,8BAA8B;EAC9B,eAAe;AACjB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,oBAAoB;EACpB,QAAQ;AACV;;AAEA;EACE,cAAc;EACd,WAAW;EACX,SAAS;EACT,6BAA6B;EAC7B,eAAe;EACf,UAAU;EACV,WAAW;AACb;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,qBAAqB;AACvB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,yBAAyB;EACzB,yBAAyB;EACzB,qBAAqB;AACvB;;AAEA;;EAEE,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,yBAAyB;EACzB,kBAAkB;EAClB,sBAAsB;EACtB,YAAY;EACZ,kBAAkB;EAClB,QAAQ;EACR,OAAO;EACP,kCAAkC;EAClC,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,wCAAwC;EACxC,qBAAqB;EACrB,aAAa;EACb,kBAAkB;AACpB","sourcesContent":["@font-face {\n  font-family: \"merriweather_regular\";\n  src:\n    url(\"./fonts/merriweather/merriweathersans-regular-webfont.woff2\")\n      format(\"woff2\"),\n    url(\"./fonts/merriweather/merriweathersans-regular-webfont.woff\")\n      format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n@font-face {\n  font-family: \"merriweather_bold\";\n  src:\n    url(\"./fonts/merriweather/merriweathersans-bold-webfont.woff2\")\n      format(\"woff2\"),\n    url(\"./fonts/merriweather/merriweathersans-bold-webfont.woff\")\n      format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n@font-face {\n  font-family: \"nimbus_regular\";\n  src:\n    url(\"./fonts/nimbus/nimbussanl-reg-webfont.woff2\") format(\"woff2\"),\n    url(\"./fonts/nimbus/nimbussanl-reg-webfont.woff\") format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n@font-face {\n  font-family: \"nimbus_bold\";\n  src:\n    url(\"./fonts/nimbus/nimbussanl-bol-webfont.woff2\") format(\"woff2\"),\n    url(\"./fonts/nimbus/nimbussanl-bol-webfont.woff\") format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n/* 1. Use a more-intuitive box-sizing model */\n*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n/* 2. Remove default margin */\n* {\n  margin: 0;\n  padding: 0;\n}\n\n/* 3. Enable keyword animations */\n@media (prefers-reduced-motion: no-preference) {\n  html {\n    interpolate-size: allow-keywords;\n  }\n}\n\nbody {\n  /* 4. Add accessible line-height */\n  line-height: 1.5;\n  /* 5. Improve text rendering */\n  -webkit-font-smoothing: antialiased;\n}\n\n/* 6. Improve media defaults */\nimg,\npicture,\nvideo,\ncanvas,\nsvg {\n  display: block;\n  max-width: 100%;\n}\n\n/* 7. Inherit fonts for form controls */\ninput,\nbutton,\ntextarea,\nselect {\n  font: inherit;\n}\n\n/* 8. Avoid text overflows */\np,\nh1,\nh2,\nh3,\nh4,\nh5,\nh6 {\n  overflow-wrap: break-word;\n}\n\n/* 9. Improve line wrapping */\np {\n  text-wrap: pretty;\n}\nh1,\nh2,\nh3,\nh4,\nh5,\nh6 {\n  text-wrap: balance;\n}\n\n/*\n  10. Create a root stacking context\n*/\n#root,\n#__next {\n  isolation: isolate;\n}\n\n@font-face {\n  font-family: \"oswald_regular\";\n  src:\n    url(\"./fonts/oswald/oswald-regular-webfont.woff2\") format(\"woff2\"),\n    url(\"./fonts/oswald/oswald-regular-webfont.woff\") format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n@font-face {\n  font-family: \"oswald_demibold\";\n  src:\n    url(\"./fonts/oswald/oswald-demibold-webfont.woff2\") format(\"woff2\"),\n    url(\"./fonts/oswald/oswald-demibold-webfont.woff\") format(\"woff\");\n  font-weight: normal;\n  font-style: normal;\n}\n\n:root {\n  --main-bg-color: rgb(255, 255, 255);\n\n  --card-border-radius: 5px;\n  --main-margin: 0 10%;\n  --center-max-width: 960px;\n\n  --color-linen: #ffede1;\n  --color-ivory: #f9fbf2;\n  --color-light-cyan: rgb(171, 226, 236);\n  --color-jordy-blue: #afcbff;\n  --color-oxford-blue: rgb(27, 28, 32);\n\n  --default-font-size: 20px; /* 18-24px */\n  --header-font-size: 55px; /* 35-50px */\n  --secondary-text-font-size: 16px;\n\n  --main-text-color: black;\n  --header-text-color: white;\n  --secondary-text-color: rgb(115, 115, 115);\n\n  --font-bold: \"oswald_demibold\";\n  --font-regular: \"nimbus_regular\";\n}\n\nhtml,\nbody {\n  height: 100%;\n  min-height: 100vh;\n  /* font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; */\n  font-size: var(--default-font-size);\n}\n\nbody {\n  overflow-y: auto;\n  overflow-x: auto;\n}\n\n/* Reset button look */\nbutton,\ninput[type=\"submit\"],\ninput[type=\"reset\"] {\n  background: none;\n  color: inherit;\n  border: none;\n  padding: 0;\n  font: inherit;\n  cursor: pointer;\n  outline: inherit;\n}\n\ninput[type=\"text\"] {\n  background: none;\n  color: inherit;\n  border: none;\n  padding: 0;\n  font: inherit;\n  outline: inherit;\n}\n\n.root.container {\n  width: 100%;\n  min-width: 450px;\n  position: relative;\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-template-rows: 65px 1fr;\n  min-height: 100vh;\n  font-family: var(--font-regular);\n  font-size: var(--default-font-size);\n}\n\n.header {\n  position: sticky;\n  top: 0;\n\n  padding: 5px 10px;\n  display: grid;\n  grid-template-columns: minmax(100px, 960px);\n  grid-template-rows: 1fr;\n  justify-content: center;\n  align-items: center;\n\n  white-space: nowrap;\n\n  background-color: var(--color-oxford-blue);\n}\n\n.header-items {\n  color: white;\n\n  max-width: 100%;\n\n  display: grid;\n  grid-template-columns: 1fr 1.3fr;\n  grid-template-rows: 1fr;\n  gap: 10px;\n  justify-content: center;\n  align-items: center;\n}\n\n.location-display {\n  width: 100%;\n  min-width: 0px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.location-search {\n  justify-self: end;\n  width: 100%;\n}\n\n/* Search bar and search button layout */\n.location-search search form {\n  display: flex;\n  gap: 10px;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n\n  border-radius: var(--card-border-radius);\n}\n\n/* Search icon and input text */\n.location-search search form p {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  flex-wrap: nowrap;\n\n  background-color: rgb(255, 255, 255);\n  padding: 3px;\n  border-radius: var(--card-border-radius);\n  width: 80%;\n  min-width: 50px;\n}\n\n.location-search search form label {\n  transform: rotateX(\"30\");\n  color: rgb(124, 124, 124);\n  padding: 0 2px;\n}\n\n.header-items .location-search #location {\n  border-radius: 5px;\n  padding-left: 2px;\n  width: 100%;\n  min-width: 70px;\n  color: gray;\n}\n\n.header-items .location-search button {\n  background-color: rgb(211, 211, 211);\n  border-radius: 5px;\n  color: rgb(59, 59, 59);\n  padding: 3px 10px;\n}\n\n.header-items .location-display {\n  font-family: var(--font-bold);\n}\n\n.intro-search {\n  margin: 20px;\n  justify-self: center;\n  width: 80%;\n  height: 40%;\n  background-color: #ffffff;\n  border-radius: 5px;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n/* Contains all main section */\n.main-container {\n  padding: 0 20px;\n  width: 100%;\n  background-color: var(--color-light-cyan);\n  display: grid;\n  grid-template-columns: minmax(100px, 1160px);\n  grid-template-rows: 1fr;\n  justify-content: center;\n  align-items: start;\n}\n\n/* Contains all cards*/\n.weather-cards {\n  width: 100%;\n  margin: 20px 0px;\n\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));\n  gap: 1rem;\n  font-family: var(--font-regular);\n}\n\n.left-cards,\n.right-cards {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n\n/* Apply to all cards */\n.card {\n  font-family: var(--font-regular);\n  max-width: 100%;\n  width: 100%;\n  min-width: fit-content;\n  background-color: white;\n  border-radius: var(--card-border-radius);\n  box-shadow: 0px 2px 6px 1px rgb(92, 150, 162);\n}\n\n.card .subheader {\n  padding: 18px 25px 2px;\n  font-size: var(--secondary-text-font-size);\n  font-family: var(--font-regular);\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  gap: 8px;\n  color: var(--secondary-text-color);\n}\n\n.card .subheader span:first-child {\n  color: var(--secondary-text-color);\n}\n\n.card hr {\n  display: block;\n  height: 1px;\n  border: 0;\n  border-top: 2px solid #e7e7e7;\n  margin: 0.2em 0;\n  padding: 0;\n}\n\n.card .card-body {\n  padding: 10px 20px 18px;\n}\n\n.card .icon {\n  flex-shrink: 0;\n}\n\n/* Applies to the Today's Weather card */\n\n.card.today {\n  /* width: 500px; */\n}\n\n.card.today .icon {\n  width: 30px;\n  height: 30px;\n  background-color: aquamarine;\n  border-radius: 50%;\n}\n\n.card.today .temp.lo .icon {\n  background-color: rgb(127, 221, 255);\n}\n\n.card.today .temp.hi .icon {\n  /* background-color: rgb(255, 150, 57); */\n  /* border: 2px solid yellow; */\n}\n\n.card.today .temp {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  gap: 10px;\n}\n\n.card.today .description {\n  padding-top: 10px;\n}\n\n.card.today .lo-hi-temps {\n  display: flex;\n  justify-content: space-between;\n  font-family: var(--font-bold);\n}\n\n/* Applies to the Current Weather card */\n\n.card.current-weather {\n  /* width: 500px; */\n}\n\n.card.current-weather .icon {\n  width: 80px;\n  height: 80px;\n  /* border-radius: 50%; */\n}\n\n.card.current-weather .card-body {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-items: center;\n  gap: 35px;\n}\n\n.card.current-weather .card-body .card-left {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: start;\n  gap: 10px;\n}\n\n.card.current-weather .card-body .card-left .card-left-top {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  gap: 10px;\n}\n\n.card.current-weather .card-body .card-left .degree span {\n  font-size: var(--header-font-size);\n  font-family: var(--font-bold);\n}\n\n.card.current-weather .card-body .card-left .degree .f-or-c .vertical-break {\n  margin: 0 2px 0 4px;\n  height: calc(var(--default-font-size) - 4px);\n  border: 0;\n  border: 0.8px solid rgb(144, 144, 144);\n  border-radius: 2px;\n}\n\n.card.current-weather #celsius {\n  color: rgb(163, 163, 163);\n}\n\n.card.current-weather .card-body .card-left .current-degree-feel .degree {\n  display: flex;\n  flex-direction: row;\n  justify-content: start;\n  align-items: center;\n  gap: 5px;\n}\n\n.card.current-weather .card-body .card-left .current-degree-feel .f-or-c {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 1px;\n}\n\n.card.current-weather .card-body .feels-like-container {\n  font-size: var(--secondary-text-font-size);\n}\n\n.card.current-weather .card-body .card-right {\n  width: 40%;\n  text-align: right;\n}\n\n.card.current-weather .card-body .card-right > div {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  gap: 5px;\n  font-size: var(--default-font-size);\n}\n\n.card.current-weather .card-body .card-right > div > span:first-child {\n  display: block;\n  text-align: right;\n  color: var(--secondary-text-color);\n  margin-right: 20px;\n}\n.card.current-weather .card-body .card-right hr {\n  width: 100%;\n  display: block;\n  height: 1px;\n  border: 0;\n  border-top: 2px solid #e7e7e7;\n  margin: 0.2em 0;\n  padding: 0;\n  justify-self: end;\n}\n\n.card.current-weather .card-body .card-right > div > span:nth-child(2) {\n  display: block;\n}\n\n/* Sun details */\n\n.card.sun {\n  /* width: 300px; */\n}\n\n.card.sun .card-body {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  gap: 30px;\n}\n\n.card.sun .card-left {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  gap: 10px;\n  align-items: center;\n}\n\n.card.sun .card-right {\n  text-align: right;\n}\n\n.card.sun .icon {\n  width: 60px;\n  height: 60px;\n  /* background-color: rgb(255, 195, 54); */\n  border: 6px solid rgb(255, 195, 54);\n  border-radius: 50%;\n}\n\n/* Moon details */\n\n.card.moon .card-body {\n  display: flex;\n  flex-direction: row;\n  /* flex-wrap: wrap; */\n  justify-content: space-between;\n  align-items: center;\n  gap: 30px;\n}\n\n.card.moon .card-body .card-left,\n.card.moon .card-body .card-right {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  gap: 10px;\n  align-items: center;\n}\n\n.card.moon .icon {\n  width: 60px;\n  height: 60px;\n  background-color: rgb(159, 159, 159);\n  border-radius: 50%;\n}\n\n.card.moon .icon .moon-img {\n  width: 250%;\n  height: 100%;\n}\n\n.card.moon .percentage {\n  /* font-size: var(--header-font-size); */\n}\n\n/* Weekly Forecast Card */\n\n.card.forecast {\n  /* width: 100%; */\n  height: fit-content;\n}\n\n.card.forecast .card-body {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: center;\n}\n\n.card.forecast .card-body .day .hi-lo-temp {\n  padding: 5px;\n  gap: 2px;\n}\n\n.card.forecast .card-body .day {\n  /* padding: 5px 5px; */\n\n  display: grid;\n  grid-template-columns: 0.7fr 0.5fr 1fr 2fr 1fr;\n  width: 100%;\n  align-items: center;\n  justify-content: space-between;\n  /* gap: 20px; */\n}\n\n.card.forecast .card-body .day:first-child {\n  padding-top: 0px;\n}\n\n.card.forecast .card-body .day:last-child {\n  padding-bottom: 0px;\n}\n\n.card.forecast .card-body .day .icon {\n  height: 40px;\n  width: 40px;\n}\n\n.card.forecast .card-body .day .precipitation {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: end;\n  gap: 3px;\n}\n\n.card.forecast .card-body hr {\n  display: block;\n  height: 1px;\n  border: 0;\n  border-top: 2px solid #e7e7e7;\n  margin: 0.2em 0;\n  padding: 0;\n  width: 100%;\n}\n\n.card.forecast .card-body .day .date {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  width: fit-content;\n}\n\n.card.forecast .card-body .day .week-day {\n  font-weight: bold;\n}\n\n.card.forecast .card-body .day .hi {\n  font-weight: bold;\n  /* font-size: 24px; */\n}\n\n.card.forecast .card-body .day .lo {\n  /* font-size: 18px; */\n}\n\n.card-forecast span {\n  display: block;\n}\n\n.card.forecast .card-body .day .hi-lo-temp {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n}\n\n.card.forecast .card-body .day .precipitation img {\n  height: 20px;\n  width: 20px;\n}\n\n.location-search search form p.error {\n  border: 3px solid #ff240c;\n  background-color: #ffd3d3;\n  color: rgb(176, 0, 0);\n}\n\n.location-search search form p.error input,\n.location-search search form p.error label {\n  background-color: #ffd3d3;\n}\n\n.location-search {\n  position: relative;\n}\n\n#location-error {\n  display: none;\n}\n\n#location-error.error {\n  display: block;\n}\n\n.error-message {\n  background-color: #ffd3d3;\n  width: fit-content;\n  min-width: fit-content;\n  height: 35px;\n  position: absolute;\n  top: 100;\n  left: 0;\n  border: 3px solid rgb(255, 28, 28);\n  margin-top: 3px;\n  border-radius: 5px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 999;\n}\n\n#location-error.error-message:after {\n  content: \"Please enter a valid location\";\n  color: rgb(176, 0, 0);\n  padding: 10px;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
class ForecastView {
  ...
  async renderCurrentWeatherCard(weatherForecast) {
    ...
    let svgModule = await __webpack_require__(5401)(`./${iconStr}.svg`);
  ...
  async renderMoonphaseCard(moon) {
    ...
    let moonphasesModule = await __webpack_require__(79)(`./${moon.phase}.png`);
  ...
  async renderForecastCard(days) {
    ...
    const raindrop = await __webpack_require__.e(/* import() */ 621).then(__webpack_require__.t.bind(__webpack_require__, 8621, 17));
    ...
    for (let i = 0; i < days.length; i++) {
      ...
      const iconImg = new Image();
      let svgModule = await __webpack_require__(5401)(`./${days[i].icon}.svg`);
...
"use strict";
module.exports = __webpack_require__.p + "86bb946c20dce2b2672d.woff2";
...
"use strict";
module.exports = __webpack_require__.p + "bb6a6874e49bcea0126a.woff2";
...
"use strict";
module.exports = __webpack_require__.p + "1063384993c3027206cc.woff";
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(365);
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, options);




       /* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A && _node_modules_css_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.locals ? _node_modules_css_loader_dist_cjs_js_styles_css__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.locals : undefined);
...
"use strict";
module.exports = __webpack_require__.p + "afbdc9faa4a1d8ba9b02.woff2";
...
"use strict";
module.exports = __webpack_require__.p + "6adbd1db45f1b76fbc72.woff";
...
"use strict";
module.exports = __webpack_require__.p + "09b1e7ac178ffe63dff0.woff";
...
"use strict";
module.exports = __webpack_require__.p + "9785f39c7498334affa4.woff";
...
"use strict";
module.exports = __webpack_require__.p + "3b30a983c56cc48bb02b.woff2";
...
"use strict";
module.exports = __webpack_require__.p + "f83910a8905ae4c2f5ed.woff";
...
"use strict";
module.exports = __webpack_require__.p + "047717ef981e67760d21.woff2";
...
"use strict";
module.exports = __webpack_require__.p + "6f0f1bd2e59733f32a85.woff";
...
"use strict";
module.exports = __webpack_require__.p + "b809caef5f156bf7c7b9.woff2";
